...
private:
	bool m_bFilesystemLoaded = false, m_bEngineLoaded = false, m_bMatSysLoaded = false, m_bClientLoaded = false, m_bParticlesLoaded = false, m_bMDLCacheLoaded = false, m_bVideoServicesLoaded = false, m_bVPhysicsLoaded = false;
